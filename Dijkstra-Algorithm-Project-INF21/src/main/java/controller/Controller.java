...
public class Controller implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        new Thread(() -> {
            try {
                Graph roads = SerializeService.loadGraph("src/main/resources/graphs/de_borders_rough.graph");
                setRoadsGraph(roads);
                Graph borders = SerializeService.loadGraph("src/main/resources/graphs/de_roads_rough.graph");
