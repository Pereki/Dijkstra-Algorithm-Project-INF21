...
public class DijkstraTest {
    public static void main(String[] args) throws Exception {
        ...
        Edge e1 = new Edge(A,B,0,2);
        Edge e2 = new Edge(B,C,0,4);
        Edge e3 = new Edge(C,D,0,2);
        Edge e4 = new Edge(D,E,0,1);
        Edge e5 = new Edge(E,F,0,6);
        Edge e6 = new Edge(F,A,0,9);
        Edge e7 = new Edge(A,G,0,15);
        Edge e8 = new Edge(B,G,0,6);
        Edge e9 = new Edge(C,I,0,15);
        Edge e10 = new Edge(D,I,0,1);
        Edge e11 = new Edge(E,H,0,3);
        Edge e12 = new Edge(F,H,0,11);
        Edge e13 = new Edge(G,I,0,2);
        Edge e14 = new Edge(I,H,0,4);
        Edge e15 = new Edge(H,G,0,15);
